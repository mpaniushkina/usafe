...
public class SlideLeftItemAnimator extends SimpleItemAnimator {
    ...
    private static final long mItemRemoveDuration = 120;
    private static final long mItemAddDuration = 120;
    private static final long mItemChangeDuration = 240;
    private static final long mItemMoveDuration = 240;
    ...
    public void runPendingAnimations() {
        ...
        if (movesPending) {
            ...
            if (removalsPending) {
                ...
                ViewCompat.postOnAnimationDelayed(view, mover, mItemRemoveDuration);
            } else {
                mover.run();
            }
        }
        ...
        if (changesPending) {
            ...
            if (removalsPending) {
                ...
                ViewCompat.postOnAnimationDelayed(holder.itemView, changer, mItemRemoveDuration);
            } else {
                changer.run();
            }
        }
        ...
        if (additionsPending) {
            ...
            if (removalsPending || movesPending || changesPending) {
                long removeDuration = removalsPending ? mItemRemoveDuration: 0;
                long moveDuration = movesPending ? mItemMoveDuration : 0;
                long changeDuration = changesPending ? mItemChangeDuration: 0;
    ...
    private void animateRemoveImpl(final ViewHolder holder) {
        ...
        animation.setDuration(mItemRemoveDuration)
    ...
    private void animateAddImpl(final ViewHolder holder) {
        ...
        animation.alpha(1).setDuration(mItemAddDuration).
    ...
    private void animateMoveImpl(final ViewHolder holder, int fromX, int fromY, int toX, int toY) {
        ...
        animation.setDuration(mItemMoveDuration).setListener(new VpaListenerAdapter() {
            @Override
            public void onAnimationStart(View view) {
    ...
    private void animateChangeImpl(final ChangeInfo changeInfo) {
        ...
        if (newView != null) {
            ...
            newViewAnimation.translationX(0).translationY(0).setDuration(mItemChangeDuration).
