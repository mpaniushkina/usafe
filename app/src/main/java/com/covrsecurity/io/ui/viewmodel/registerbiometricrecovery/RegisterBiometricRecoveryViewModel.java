...
public class RegisterBiometricRecoveryViewModel extends BaseViewModel {
    ...
    public RegisterBiometricRecoveryViewModel(RegisterBiometricRecoveryUseCase registerBiometricRecoveryUseCase) {
