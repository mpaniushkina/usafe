...
public class StyleAttributeHandler extends WrappingStyleHandler  {
    ...
    public StyleAttributeHandler(StyledTextHandler wrapHandler, DisplayMetrics displayMetrics) {
        super(wrapHandler);
    ...
    private Style parseStyleFromAttribute(Style baseStyle, String attribute) {
        ...
        for ( String pair: pairs ) {
            ...
            if (key.equals("font-size") && displayMetrics != null) {
                value = value.substring(0, value.length()-2);
                int size = Integer.parseInt(value);
                Log.e("StyleAttributeHandler", "size: " + size );
                Double dSize = null;
                if (size != 0) {
                    ...
                    if (dSize != null) {
                        value = String.valueOf((int) Math.round(dSize)) + "px";
                    }
                }
