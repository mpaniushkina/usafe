...
public class HtmlSpanner {
    ...
    private HashSetMap<String, TagNodeHandler> handlers;
     ...
     * Creates a new HtmlSpanner using a default HtmlCleaner instance.
     */
    public HtmlSpanner(HashMap<String, TagNodeHandler> handlers, DisplayMetrics displayMetrics) {
        this(createHtmlCleaner(), new SystemFontResolver(), handlers, displayMetrics);
    }
     ...
     * @param cleaner
     */
    public HtmlSpanner(HtmlCleaner cleaner, FontResolver fontResolver, HashMap<String, TagNodeHandler> handlers, DisplayMetrics displayMetrics) {
        this.htmlCleaner = cleaner;
        this.fontResolver = fontResolver;
        this.handlers = handlers != null ? new HashSetMap<>(handlers) : new HashSetMap<String, TagNodeHandler>();
    ...
    public void registerHandler(String tagName, TagNodeHandler handler) {
        this.handlers.putIfAbsent(tagName, handler);
    ...
    private StyledTextHandler wrap(StyledTextHandler handler) {
        return new StyleAttributeHandler(new AlignmentAttributeHandler(handler), displayMetrics);
    }
